...
function printMonthlyReport({monthName,yr,cats,md,tInc,tAc,subRename,fmt,fN,pc,cT}){
...
export default function App(){
  ...
  return<EB><div style={{fontFamily:"'Segoe UI',system-ui,sans-serif",color:C.tx,minHeight:"100vh",background:C.bg}}>
    ...
    {vw==="dash"&&<div>
      ...
      <div style={{display:"grid",gridTemplateColumns:isMob?"1fr":"1fr 1fr",gap:10,marginBottom:10,alignItems:"start"}}>
        {/* Left column */}
      ...
      {/* Charts */}
      <div style={{display:"grid",gridTemplateColumns:isMob?"1fr":"1fr 1fr",gap:8,marginTop:4}}>
